# Codon Pygments lexer based on Python's
...
class CodonLexer(RegexLexer):
    ...
    codonwords = ['__import__', 'abs', 'all', 'any', 'bin', 'bool', 'bytearray', 'bytes',
    ...
    tokens['builtins'] = [
        (words(codonwords, prefix=r'(?<!\.)', suffix=r'\b'),
         Name.Builtin),
    ...
    def analyse_text(text):
        return shebang_matches(text, r'codon')
